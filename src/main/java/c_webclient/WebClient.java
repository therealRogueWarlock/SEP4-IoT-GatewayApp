...
public interface WebClient {
    /**
     * Creates an HTTP PUT request on the given URL with the given Object
    ...
    /**
     * Creates an HTTP POST request on the given URL with the given Object
    ...
    /**
     * Creates an HTTP GET request on the given URL
    ...
    /**
     * Creates an HTTP DELETE request on the given URL
